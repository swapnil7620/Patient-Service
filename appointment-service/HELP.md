...
* The original package name 'com.swapnil.appointment-service' is invalid and this project uses 'com.swapnil.appointment_service' instead.
...
```
$ docker run --rm -p 8080:8080 appointment-service:0.0.1-SNAPSHOT
```
